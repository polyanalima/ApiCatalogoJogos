...
namespace ApiCatalogoJogos.Repositories
{
	...
	public class JogoRepository : IRepository
	{
		private static Dictionary<Guid, Jogo> jogos = new Dictionary<Guid, Jogo>()
		{
			...
			{Guid.Parse("92576bd2-388e-4f5d-96c1-8bfda6c5a268"), new Jogo{ Id = Guid.Parse("92576bd2-388e-4f5d-96c1-8bfda6c5a268"), Nome = "Street Figther V", Produtora = "Capcom", Preco = 80} },
		...
		public Task<List<Jogos>> Obter (int pagina, int quantidade)
		{
			...
			return Task.FromResult(Jogos.Values.Skip((pagna - 1> = quantidade).Take(quantidade).ToList());
